        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div className="space-y-4 text-base md:text-lg text-gray-600 font-light leading-relaxed max-w-xl">
              <p>
                At <span className="text-dark-950 font-medium">Asutosh Photography</span>, we archive the soul of every moment. Founded on the principles of luxury and storytelling, we've spent over 6 years refining the alchemy of light and emotion.
              </p>
              <p>
